myAppModule.controller('mediaImagesController', function ($scope, $state, mediaFactory, $routeParams, FileUploader){
    $scope.clientInfo = {}
    $scope.mediaInfo = []
    $scope.pics = [];
  ...
  var uploader = $scope.uploader = new FileUploader({
        ...
        uploader.onCompleteAll = function() {
          ...
          mediaFactory.savePics($scope.mediaInfo, function(res){
            $scope.mediaInfo = []
            console.log(res)
          });
